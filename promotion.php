	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form class="form-horizontal" action="php_action/createPromotion.php" method="post" id="getOrderReportForm">
					<div class="form-group">
						<label for="budget" class="col-sm-2 control-label">Budget</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="budget" name="budget" placeholder="Budget Amount" />
						</div>
					</div>
					<div class="form-group">
						<label for="sortBy" class="col-sm-2 control-label">Sort By</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="sortBy" name="sortBy" placeholder="Sort Packages Based On" />
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" class="btn btn-success" id="createPromotionBtn" data-loading-text="Loading..." autocomplete="off"> Create Promotion Package</button>
						</div>
					</div>
				</form>
